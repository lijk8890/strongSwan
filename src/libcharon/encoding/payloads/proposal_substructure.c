...
typedef enum {
	...
	IKEV1_ESP_ENCR_SMS4 = 256,
	IKEV1_ESP_ENCR_SMS4_CBC = 257,
} ikev1_esp_transid_t;
...
static algo_map_t map_encr[] = {
	...
	{ IKEV1_ENCR_SMS4,			ENCR_SMS4 },
	{ IKEV1_ENCR_SMS4_CBC,		ENCR_SMS4_CBC },
};
...
static algo_map_t map_esp[] = {
	...
	{ IKEV1_ESP_ENCR_SMS4,					ENCR_SMS4 },
	{ IKEV1_ESP_ENCR_SMS4_CBC,				ENCR_SMS4_CBC },
};
