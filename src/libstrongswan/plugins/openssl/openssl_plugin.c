	...
	private_openssl_plugin_t *this, plugin_feature_t *features[])
{
	static plugin_feature_t f[] = {
		...
		PLUGIN_REGISTER(CRYPTER, openssl_crypter_create),
			PLUGIN_PROVIDE(CRYPTER, ENCR_SMS4, 16),
			PLUGIN_PROVIDE(CRYPTER, ENCR_SMS4_CBC, 16),
...
#endif
		PLUGIN_PROVIDE(PRIVKEY_SIGN, SIGN_SM2_WITH_SM3_DER),
		PLUGIN_PROVIDE(PUBKEY_VERIFY, SIGN_SM2_WITH_SM3_DER),
